          ...
          children: [
            Column(
              children: [
                ...
                SizedBox(height: 1.w,),
                Text(isConfirmed ? "Order Confirmed" : "Confirmation Pending", style: globalTextStyle.copyWith(color: black, fontSize: currentStatus == 0 ? 3.w : 2.5.w, fontWeight: FontWeight.bold),),
                SizedBox(height: 1.w,),
